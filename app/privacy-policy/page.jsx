            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    If you have questions about this Privacy Policy or your data, please contact us at <a href="mailto:privacy@clipmailo.com" className="text-indigo-500 hover:underline">privacy@clipmailo.com</a>.
                  </p>
                </div>
              </div>
