...
const UnsubscribePage = () => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setStatus("success"); // Set status to success after successful API call
    } catch (error) {
      console.error(error);
      setStatus("error"); // Set status to error if the API call fails
    }
  };
        ...
        {status === "success" ? (
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Good bye! You have been removed from our mailing list.
            </p>
            {reason && (
